...
const GROUPS: Array<{ label: string; perms: readonly string[] }> = [
  ...
  { label: 'Attendance', perms: [PERMISSIONS.VIEW_TEAM_ATTENDANCE, PERMISSIONS.VIEW_ALL_ATTENDANCE, PERMISSIONS.EDIT_ATTENDANCE_RECORDS, PERMISSIONS.MANAGE_PROJECTS] },
